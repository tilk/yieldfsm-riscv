...
data FSMState_rvfsm
  = CuseAlu_rvfsm (CpuWord {-a-}, CpuWord {-b-}, CTrvfsmuseAlu)
  | Cwhile_rvfsm (BitVector 30 {-adr-}, BitVector 4 {-sel-}, CpuWord {-pc?-}, CTrvfsmwbRead)
  | Cwhile_rvfsm0 (BitVector 30 {-adr-}, CpuWord {-dat-}, BitVector 4 {-sel-}, CpuWord {-pc-})
  | Cforever_rvfsm (Instr, CpuWord {-r-}, CpuWord {-pc-})
...
data CTrvfsmuseAlu
  = CrvfsmuseAlu_pc4 ()
  | CrvfsmuseAlu_op (CpuWord {-pc-}, CpuWord {-imm-}, Instr, AluInstr)
  deriving (Show, Generic, NFDataX)
...
rvfsmManualOpt startPC
  ...
  where
      fsmInitState_rvfsm_a1QRq
        = CuseAlu_rvfsm (startPC, 4, CrvfsmuseAlu_pc4 ())
      fsmFunc_rvfsm_a1QRs
        ...
        = let v_a1QQG = ((doAluIn aiAdd) a_a1Qwv) b_a1Qww
          in
            case c_a1QDK of
              CrvfsmuseAlu_op (r_a1QzR, imm_a1QA4, instr_a1QA5,
                                    aluInstr_a1QA6)
                -> (Cforever_rvfsm3
                ...
                -> let sel_a1QQf = negate 1 in
                   ...
                   in
                     if wbAck wb then
                         ...
                         (Cwhile_rvfsm
                            (adr_a1QQe, sel_a1QQf, a_a1Qwv, CrvfsmwbRead_instr ali), 
                          ((readWishboneOut adr_a1QQe) sel_a1QQf, emptyRegFileIn, v_a1QQG))
      fsmFunc_rvfsm_a1QRs
      ...
      fsmFunc_rvfsm_a1QRs
        ...
        (wb, _, _)
        = if wbAck wb then
              (CuseAlu_rvfsm (v_a1Qxr, 4, CrvfsmuseAlu_pc4 ()), 
      ...
      fsmFunc_rvfsm_a1QRs
        ...
        (_, _, _)
        = (CuseAlu_rvfsm (v_a1QAn, 4, CrvfsmuseAlu_pc4 ()), 
      ...
      fsmFunc_rvfsm_a1QRs
        ...
        = let f3_a1QFE = bitCoerce $ iFunct3 instr_a1QA5 in
          ...
          in
            if wbAck wb then
                (CuseAlu_rvfsm (pc_a1QzL, 4, CrvfsmuseAlu_pc4 ()), 
            ...
            OLui
              -> (CuseAlu_rvfsm (pc_a1QzL, 4, CrvfsmuseAlu_pc4 ()), 
                  (emptyWishboneOut, (writeRegFileIn (iRD instr_a1QA5)) imm_a1QA4, 
                   emptyAluIn))
            OJal
              -> (CuseAlu_rvfsm (r_a1QA8, 4, CrvfsmuseAlu_pc4 ()), 
                  (emptyWishboneOut, (writeRegFileIn (iRD instr_a1QA5)) pc_a1QzL, 
                   emptyAluIn))
            OJalr
              -> (CuseAlu_rvfsm (ali, 4, CrvfsmuseAlu_pc4 ()), 
                  (emptyWishboneOut, (writeRegFileIn (iRD instr_a1QA5)) pc_a1QzL, 
                   ((doAluIn aiAdd) (rfRS1V rf)) imm_a1QA4))
            OAuipc
              -> (CuseAlu_rvfsm (pc_a1QzL, 4, CrvfsmuseAlu_pc4 ()), 
